      ...
      <main>
        <section className="hero">
          <div className="hero-content">
            ...
            <h2>Equipamiento para tu próxima aventura</h2>
            <p>
              Geinomi conecta una interfaz React con la API REST de la PEC 3 para listar,
              crear, editar y eliminar productos outdoor con datos reales desde MongoDB Atlas.
            </p>
          ...
          <div className="hero-card" aria-label="Resumen del proyecto">
            <img src="/geinomi-logo.svg" alt="Logo de Geinomi" />
            <p>API conectada:</p>
